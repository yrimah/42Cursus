...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/08 13:18:20 by yrimah            #+#    #+#             */
/*   Updated: 2023/01/08 13:18:26 by yrimah           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "../includes/checker.h"

static void	ft_init_arrays(int (*operations[11])(t_program *, int),
...
void	ft_do(t_program *ps, char *buf)
{
	int		(*operations[11])(t_program *, int);
	char	*instructions[11];
	int		i;
...
void	ft_stacksorted(t_program *ps)
{
	t_stack		*current;
	long int	n;
